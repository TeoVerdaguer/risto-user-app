...
const Home = ({ navigation }) => {
  ...
  const getCategories = async () => {
    const URL = 'https://api-ibook-dev.herokuapp.com/business/get-categories/';
  ...
  return (
    ...
    <NavigationContainer>
        ...
        <Appbar.Header elevated style={{backgroundColor: '#e1e1e1'}}>
            ...
            <Appbar.Content titleStyle={Styles.headerSubtitle} title="Buscar en" />
            <Appbar.Content titleStyle={Styles.headerTitle} title="Ubicacion Actual" onPress={() => {navigation.navigate('Map')}} />
            </View>
        ...
        <Text
            style={{fontSize: 20, margin: 10, fontWeight: '700', color: '#202025'}}>
